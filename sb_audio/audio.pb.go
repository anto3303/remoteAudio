...
type ClientRequest struct {
	StreamAudio      *bool   `protobuf:"varint,1,opt,name=stream_audio,json=streamAudio" json:"stream_audio,omitempty"`
...
func (m *ClientRequest) GetStreamAudio() bool {
	if m != nil && m.StreamAudio != nil {
		return *m.StreamAudio
	}
	return false
}
...
func (m *ClientRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StreamAudio", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorAudio = []byte{
	...
	,
}
